...
external_url 'https://gitlab.taxpay.uz'
...
registry_external_url 'https://gitlab.taxpay.uz:5050'

### Settings used by GitLab application
  gitlab_rails['registry_enabled'] = true
  #registry['registry_https'] = true
  #registry['ssl_certificate'] = "/etc/letsencrypt/live/gitlab.taxpay.uz/fullchain.pem"
  #registry['ssl_certificate_key'] = "/etc/letsencrypt/live/gitlab.taxpay.uz/privkey.pem"
  gitlab_rails['registry_host'] = "gitlab.taxpay.uz"
...
# nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.taxpay.uz.crt"
# nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/gitlab.taxpay.uz.key"
...
#  nginx['custom_gitlab_server_config'] = "/etc/nginx/sites-available/gitlab.conf"
